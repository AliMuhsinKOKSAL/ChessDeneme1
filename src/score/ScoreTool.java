...
public class ScoreTool {
	...
	public ScoredSquare findBestMove(ArrayList<ScoredPiece> scoredPieces) {
		int bestMove = Collections.max(BoardCreator.cBoard.scoreTool.saveScoredSquare(scoredPieces));
...
//				+ bestScoredSquare.square.y + " bestResult: " + bestScoredSquare.result);
	...
	public ArrayList<Integer> saveScoredSquare(ArrayList<ScoredPiece> scoredPieces) {
	...
	public int pieceFactor(Piece piece) {
		int i = 0;
		if (piece.type == PieceType.pawn) {
			...
			i = (int) Double.POSITIVE_INFINITY;
		}
		return i;
	}
	
	public int calculatePiecePoint(Piece piece) {
