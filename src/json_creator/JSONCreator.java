...
public class JSONCreator {
	...
	public String generateJSON(int gameId, int moveId, String move) {
		...
		json.append("},");
		json.append("\"half_move_number\":"+BoardCreator.cBoard.boardTool.halfMoveClock+",");
		json.append("\"full_move_number\":"+Math.round(((double)BoardCreator.cBoard.boardTool.halfMoveClock/2))+",");
